...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "PHIDID_ADP1001") == 0)
		return (50);
	...
	if (mos_strcasecmp(name, "PHIDID_HUB0002") == 0)
		return (66);

	if (mos_strcasecmp(name, "PHIDID_HUB0004") == 0)
		return (67);

	if (mos_strcasecmp(name, "PHIDID_HUB0005") == 0)
		return (68);
	...
	if (mos_strcasecmp(name, "PHIDID_TMP1300") == 0)
		return (91);
	...
	if (mos_strcasecmp(name, "PHIDID_GENERICUSB") == 0)
		return (99);

	if (mos_strcasecmp(name, "PHIDID_GENERICVINT") == 0)
		return (100);
	...
	if (mos_strcasecmp(name, "PHIDID_VINTSERVO_S2313M") == 0)
		return (106);
	...
	if (mos_strcasecmp(name, "PHIDID_VINTSERVO_S3317M") == 0)
		return (112);

	if (mos_strcasecmp(name, "PHIDID_VINTSERVO_S4309M") == 0)
		return (113);

	if (mos_strcasecmp(name, "PHIDID_VINTSERVO_S4309R") == 0)
		return (114);

	if (mos_strcasecmp(name, "PHIDID_STC1001") == 0)
		return (115);

	if (mos_strcasecmp(name, "PHIDID_USBSWITCH") == 0)
		return (116);

	if (mos_strcasecmp(name, "PHIDID_MCSML1") == 0)
		return (117);
	...
	if (mos_strcasecmp(name, "PHIDCHSUBCLASS_RCSERVO_EMBEDDED") == 0)
		return (112);
